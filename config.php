...
/*
 * Configuración de Jongox Envíos.
 *
 * Se pueden definir las variables de entorno JONGOX_DB_HOST,
 * JONGOX_DB_NAME, JONGOX_DB_USER y JONGOX_DB_PASSWORD para reemplazar
 * estos valores al desplegar la aplicación.
 */

function jongox_database_config(): array
{
    return [
        'host' =>  'mysql-jongox.alwaysdata.net',
        'name' =>  'jongox_envios',
        'user' =>  'jongox',
        'password' =>  'clase1234'
    ];
